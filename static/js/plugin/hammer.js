 ...
 *
 * This library code is modified from the original at https://github.com/hammerjs/hammer.js
 * To fix a bug that 'pointerleave' events are not recognized. This results in gestures on mobile working the first time,
 * but then no subsequent times due to the pointer store not being cleared properly
 * */
...
(function (window, document, exportName, undefined) {
    ...
    var POINTER_ELEMENT_EVENTS = 'pointerdown pointerleave';
    ...
    TouchAction.prototype = {
        ...
        preventDefaults: function (input) {
            ...
            var hasPanY =
                inStr(actions, TOUCH_ACTION_PAN_Y) && !TOUCH_ACTION_MAP[TOUCH_ACTION_PAN_Y];
            var hasPanX =
                inStr(actions, TOUCH_ACTION_PAN_X) && !TOUCH_ACTION_MAP[TOUCH_ACTION_PAN_X];
